...
using System;
using UnityEngine;
using UltimateXR.Examples.FullScene.Lab;
...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class ClawMachine1 : MonoBehaviour
    {
        ...
        void Start()
        {
         ...
         void Update()
        {
            Debug.Log("Rotation Val" +StickTransform.rotation);
 
            m_JoystickValue.x = -StickTransform.rotation.z;
            m_JoystickValue.y = StickTransform.rotation.x;
